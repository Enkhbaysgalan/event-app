      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="max-w-lg mx-auto px-5 pb-6 pt-4 bg-gradient-to-t from-[#0c0c12] via-[#0c0c12] to-transparent">
          <button
            ...
            disabled={submitting}
            className="w-full h-[50px] bg-primary-light font-display font-black text-[15px] uppercase tracking-widest text-white active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60"
          >
            {submitting ? (
